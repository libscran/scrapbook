...
```{r pca-416b, fig.width=10, fig.height=5, fig.cap="First two PCs for the 416B dataset, before and after blocking on uninteresting experimental factors. Each point represents a cell, colored by its combination of experimental factors."}
...
In contrast, setting `center.scores.by.block=TRUE` will center the PC scores within each block at the origin, which is effectively equivalent to deriving the scores from the residuals.
