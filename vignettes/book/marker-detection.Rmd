...
Personally, we disapprove of using variable areas to represent information as this can generate misleading visualizations, but hey, to each their own.
...
though marker detection is likely the least of our concerns with this kind of experimental design. 
