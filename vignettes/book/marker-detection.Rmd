...
This cancels out any batch effects so that they are not conflated with biological differences between clusters and cannot inflate variances within clusters.
...
A similar calculation is applied to the mean log-expression and proportion of detected cells. 
