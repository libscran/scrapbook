...
```{r trend-plot-spike-in, fig.cap="Variance of endogenous genes (black) and spike-in transcripts (blue crosses) in the Zeisel brain dataset, as a function of the mean. A mean-dependent trend is fitted to the spike-in variances (red)."}
...
trend.zeisel <- approxfun(var.spike.zeisel$means, var.spike.zeisel$fitted)
curve(trend.zeisel, add=TRUE, col="dodgerblue", lwd=2)
```
