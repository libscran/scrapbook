...
previewMarkers(markers.adt2rna.pbmc[["1"]], columns=c("Symbol", "mean", "detected", lfc = "delta.mean.mean"))
```
...
Instead, we scale the modalities to balance their contributions to the combined matrix with the `scaleByNeighbors()` function.
