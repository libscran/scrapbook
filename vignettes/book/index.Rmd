...
But if you want to really look under the hood, the rest of this book will go over all of the individual steps in the mysterious `analyze()` function, such as:
