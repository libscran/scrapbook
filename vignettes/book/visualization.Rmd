...
```{r tsne-perplexity, fig.cap="$t$-SNE plots constructed from the top PCs in the Zeisel brain dataset, using a range of perplexity values. Each point represents a cell, coloured according to its annotation.", fig.width=15, fig.height=6}
...
```{r umap-neighbors, fig.cap="UMAP plots constructed from the top PCs in the Zeisel brain dataset, using a range of neighbors. Each point represents a cell, coloured according to its annotation.", fig.width=15, fig.height=6}
...
```{r umap-mindist, fig.cap="UMAP plots constructed from the top PCs in the Zeisel brain dataset, using a range of minimum distances. Each point represents a cell, coloured according to its annotation.", fig.width=15, fig.height=6}
...
If we can't decide between a UMAP and a $t$-SNE, we can just compute them both^[Porque no los dos?] via the `runAllNeighborSteps.se()` function.
...
Personally, I only use the $t$-SNE/UMAP coordinates for visualization.
