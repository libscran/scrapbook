...
as shown below for _Malat1_^[Yet another appearance for my favorite gene.] (Figure \@ref(fig:norm-effect-malat)).
...
logcounts.spike.richard <- normalizeCounts(counts(sce.qc.richard), spike.factors.richard)
...
markers1 <- scoreMarkers(logcounts.lib.richard["ENSMUSG00000092341",,drop=FALSE], sce.richard$stimulus, all.pairwise=TRUE)
markers2 <- scoreMarkers(logcounts.spike.richard["ENSMUSG00000092341",,drop=FALSE], sce.richard$stimulus, all.pairwise=TRUE)
